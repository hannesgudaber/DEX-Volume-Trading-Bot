...
![Normal Mode + Sell Pressure Simulation](./WORK.jpg)  
*Test behavioral dynamics like 85% sell ratios or 70/30 buy/sell splits.*

![Extreme Sell-Off Simulation](./sell%20off.jpg)  
*Simulate worst-case scenarios like mass dumps or sudden liquidity exits (educational only).*
...
python-dotenv, requests, cryptography

eth-utils, hexbytes, eth-abi, eth-keys, etc.

📌 Make sure your environment supports modern EVM libraries. This is not a beginner tool.
...
⚠️ For educational use only. Use responsibly. Learn deeply. Build smarter.
